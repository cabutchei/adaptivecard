...
class Mixin:    # essa é uma classe do tipo mixin. Não tem funcionalidade própria, serve para fornecer funcionalidade a outras classes.
            ...
            for variable in variables:
                    ...
                    if value != None:
                        ...
                        if type_origin == None:
                            ...
                            type_origins_list = [x if get_origin(x) == None else get_origin(x) for x in expected_types_tuple]
    ...
    def to_dict(self):
        dic = json.loads(json.dumps(self, default = lambda obj : obj.__dict__))
        return dic
